...
public class PaymentService {
    ...
    @Transactional
    public String createPaymentForUpgrade(HttpSession session, String type, int value, String vnp_TmnCode, String vnp_ReturnUrl, String vnp_HashSecret, HttpServletRequest request) {
        ...
        redisService.saveRoomID(orderId, (Long) session.getAttribute("roomID"), 10); // lưu 10 phút10);
        redisService.saveUser(orderId, (String) session.getAttribute("username"), 10);
